...
drop_for_order_details = ['customer','item','price','credit_card_number',]
...
products_table_df = products_table_df.drop_duplicates(subset=['item'])

col_orders_details_table = 'date_time,branch,total_price,payment_type'
